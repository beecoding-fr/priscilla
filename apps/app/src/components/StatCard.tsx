...
export function StatCard({
  ...
  return (
    <Card
      className={`group relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 p-5 ${colorClasses.card}`}
    >
      {!isGradient && (
        <div
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-4">
          <p className={`text-sm ${colorClasses.labelColor}`}>{label}</p>
          <div
